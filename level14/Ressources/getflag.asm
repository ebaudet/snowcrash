Dump of assembler code for function main:               # b main
   ...
   0x08048989 <+67>:	call   0x8048540 <ptrace@plt>   # b ptrace # n # n
   0x0804898e <+72>:	test   %eax,%eax                # set $eax=1
   0x08048990 <+74>:	jns    0x80489a8 <main+98>      # jump if EAX < 0
   0x08048992 <+76>:	movl   $0x8048fa8,(%esp)
   0x08048999 <+83>:	call   0x80484e0 <puts@plt>
   0x0804899e <+88>:	mov    $0x1,%eax
   0x080489a3 <+93>:	jmp    0x8048eb2 <main+1388>    # goto end

   0x080489a8 <+98>:	movl   $0x8048fc4,(%esp)
   0x080489af <+105>:	call   0x80484d0 <getenv@plt>
   0x080489b4 <+110>:	test   %eax,%eax
   0x080489b6 <+112>:	je     0x80489ea <main+164>     # jump if EAX == 0
   ...
   0x080489e5 <+159>:	jmp    0x8048eb2 <main+1388>    # goto end
   ...
   0x08048a00 <+186>:	jle    0x8048a34 <main+238>     # jump if EAX <= 0
   ...
   0x08048a2f <+233>:	jmp    0x8048eb2 <main+1388>    # goto end
   ...
   0x08048a51 <+267>:	jne    0x8048e88 <main+1346>    # jump if ESP(+0x14) != 0xffffffff (-1) <<<<<<<<<<<<<<<
   ...
   0x08048a84 <+318>:	jmp    0x8048eb2 <main+1388>    # goto end
   ...
   0x08048a9f <+345>:	je     0x8048aae <main+360>     # jump if EAX == 0
   ...
   0x08048acf <+393>:	je     0x8048e46 <main+1280>       # jump if $eax == 0
   ...
   0x08048afd <+439>:	call   0x80484b0 <getuid@plt>       # b getuid
   0x08048b02 <+444>:	mov    %eax,0x18(%esp)
   0x08048b06 <+448>:	mov    0x18(%esp),%eax
   0x08048b0a <+452>:	cmp    $0xbbe,%eax
   0x08048b0f <+457>:	je     0x8048ccb <main+901>         # jump if EAX == 3006
   0x08048b15 <+463>:	cmp    $0xbbe,%eax
   0x08048b1a <+468>:	ja     0x8048b68 <main+546>         # jump if EAX > 3006
   0x08048b1c <+470>:	cmp    $0xbba,%eax
   0x08048b21 <+475>:	je     0x8048c3b <main+757>         # jump if EAX == 3002
   0x08048b27 <+481>:	cmp    $0xbba,%eax
   0x08048b2c <+486>:	ja     0x8048b4d <main+519>
   0x08048b2e <+488>:	cmp    $0xbb8,%eax                  # 3000
   ...
   0x08048b4d <+519>:	cmp    $0xbbc,%eax                  # 3004
   ...
   0x08048bee <+680>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048c12 <+716>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048c36 <+752>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048c5a <+788>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048c7e <+824>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048ca2 <+860>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048cc6 <+896>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048cea <+932>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048d0e <+968>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048d32 <+1004>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048d56 <+1040>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048d7a <+1076>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048d9e <+1112>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048dc2 <+1148>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048de3 <+1181>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048e04 <+1214>:	jmp    0x8048e2f <main+1257>    # print && goto end
   ...
   0x08048e44 <+1278>:	jmp    0x8048ead <main+1383>        # goto end
   ...
   0x08048e5c <+1302>:	jne    0x8048e89 <main+1347>        # jump if EAX != 0
   ...
   0x08048e86 <+1344>:	jmp    0x8048ead <main+1383>        # goto end
   ...
   0x08048ea7 <+1377>:	jne    0x8048a89 <main+323>         # jump if EAX != 0
